...
<body>
    <div class="container">
        <div class="row">
            <a href="{{route('home')}}" class=" d-block bg-danger text-white py-1 text-decoration-none "style="width:150px; heigth:150px; border-radius:10px; text-align:center">← Regresar</a>
